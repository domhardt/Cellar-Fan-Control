...
// for state machine
unsigned long ventilationInterval = DEFAULT_VENTILATION_INTERVAL_MINUTES * 60UL * 1000UL; // in millis
unsigned long waitInterval = DEFAULT_WAIT_INTERVAL_MINUTES * 60UL * 1000UL;        // in millis
